...
import { _jwt_token_decoded_b, _jwt_token_decoded_Ctx } from './_jwt_token_decoded_b'
...
export const _koa_jwt_token_decoded_b = _b<_koa_jwt_token_decoded_Ctx, typeof key>(key, ctx=>{
