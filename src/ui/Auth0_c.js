...
import { auth0_token_error$_b, auth0_token_json$_b, post_auth0_oauth_token_b, password_realm_body__b, close_auth0_b, logout_auth0_token_error_b, post_auth0_dbconnections_signup_b, post_auth0_auth_change_password_b, open_auth0_login_b, validate_auth0_signup, clear_auth0_token_error_b, auth0_opened_class$_b, validate_auth0_forgot_password, post_auth0_passwordless_start_b, auth0_body__b, open_auth0_forgot_password_check_email_b, validate_auth0_change_password, } from '@ctx-core/auth0';
export class Auth0_c {
    constructor(ctx) {
        this.ctx = ctx;
        this.login_auth0_body_fn = auth0_body__b(this.ctx, 'login_auth0_body_fn');
        this.login_password_realm_body_fn = password_realm_body__b(this.ctx, 'login_password_realm_body_fn', this.login_auth0_body_fn);
        this.signup_auth0_body_fn = auth0_body__b(this.ctx, 'signup_auth0_body_fn');
        this._signup_password_realm_body = password_realm_body__b(this.ctx, 'signup_password_realm_body_fn', this.signup_auth0_body_fn);
        ...
        this.login = async (data, schedule_forms_clear = () => { }) => {
            const response = await this.post_auth0_oauth_token(this.login_password_realm_body_fn(data));
            if (response.ok) {
        ...
        this.onsubmit_forgot_password = async (event, ctx) => {
            ...
            await this.post_auth0_passwordless_start(this.login_auth0_body_fn(data));
...
//# sourceMappingURL=../src/ui/Auth0_c.js.map